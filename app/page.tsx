          ...
          <section className="modal-card" role="dialog" aria-modal="true" aria-labelledby="card-modal-title" onMouseDown={(event) => event.stopPropagation()}>
            ...
            <form onSubmit={submitCardEntry}>
              {cardModal === 'account' ? <>
                ...
                <div className="field-row"><label><span>Outstanding balance</span><input name="outstandingBalance" required type="text" inputMode="decimal" pattern="[0-9]+([.,][0-9]{1,2})?" placeholder="2365,14" /></label><label><span>Monthly installment</span><input name="installment" required type="text" inputMode="decimal" pattern="[0-9]+([.,][0-9]{1,2})?" placeholder="113,69" /></label></div>
                ...
                <div className="field-row"><label><span>Credit limit</span><input name="creditLimit" required type="text" inputMode="decimal" pattern="[0-9]+([.,][0-9]{1,2})?" placeholder="3300,00" /></label><label><span>Currently used</span><input name="openingUsed" required type="text" inputMode="decimal" pattern="[0-9]+([.,][0-9]{1,2})?" placeholder="1340,76" /></label></div>
                ...
                <div className="field-row"><label><span>Amount</span><input name="amount" required type="text" inputMode="decimal" pattern="[0-9]+([.,][0-9]{1,2})?" /></label><label><span>Date</span><input name="date" required type="date" defaultValue={today} /></label></div>
