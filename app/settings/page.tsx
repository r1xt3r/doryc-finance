...
export default function SettingsPage() {
  ...
  </div><footer><Link href="/privacy">{tr('Privacy', 'Privacidad')}</Link><Link href="/terms">{tr('Terms', 'Términos')}</Link><span>{tr('Official contact pending configuration', 'Contacto oficial pendiente de configurar')}</span></footer></main>;
}
